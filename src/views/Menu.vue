        ...
        <div class="flex justify-between max-w-7xl w-full">
            ...
            <nav class="grid place-items-center">
                <ul class="flex text-gray-700 font-medium">
                    <li class="mx-6">
                        <router-link class="py-2 px-4 hover:bg-slate-200 rounded-lg duration-200 border border-transparent" to="dashboard">Dashboard</router-link>
                    </li>
                    <li class="mx-6">
                        <router-link class="py-2 px-4 hover:bg-slate-200 rounded-lg duration-200 border border-transparent" to="repositories">Repositories</router-link>
                    </li>
                    <li class="mx-6">
                        <router-link class="py-2 px-4 hover:bg-slate-200 rounded-lg duration-200 border border-transparent" to="servers">Servers</router-link>
                    </li>
                    <li class="mx-6">
                        <router-link class="py-2 px-4 hover:bg-slate-200 rounded-lg duration-200 border border-transparent" to="logs">Logs</router-link>
                    </li>
                </ul>
            </nav>
